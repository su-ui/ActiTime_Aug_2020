...
public class TimeTrackPage extends TestBase {
	...
	public void setNewCustomer() throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOf(
				driver.findElement(By.xpath("//div[text()='                Create New Tasks            ']"))));
		...
		/*
		 * for(WebElement ele:elements) { Thread.sleep(1000);
		 * System.out.println(ele.getText());
		 * 
		 * if(ele.getText().contains("New Customer")) { ele.click(); break; } }
		 */
